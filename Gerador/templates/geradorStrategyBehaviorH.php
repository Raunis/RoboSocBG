...
$value = exec('bash ./strategyBehaviorCreatorH.sh');

$arquivo_antigo = "../../../bahiart/bahia/strategy/testebehavior.h";
$arquivo_novo = "../../../bahiart/bahia/strategy/Behave".$_SESSION["comportamento"].".h";
...
$template_log="File name:      Behave".$_SESSION["comportamento"].".h".PHP_EOL."Located in:         bahiart\strategy".PHP_EOL
;
...
$arquivo=fopen('../../../'.$_SESSION['time'].'/strategy/Behave'.$_SESSION["comportamento"].'.h','r');
$linhas_final=0;
while(true) {
    $linha = fgets($arquivo);
    if ($linha==null) break;
...
header("Location: http://localhost/Gerador/templates/geradorSpfield.php?totalInserido=".$_GET["totalInserido"]);