<html lang="en">
        ...
        <div class = "fancyFormRight">
             ...
             name="posse" value="semBola" onclick="
                ...
                if (document.getElementById(1).checked==true ) {
                  ...
                  document.getElementById('player').disabled=false;
                   ...
                   if (document.getElementById('semBola').checked==true) {
                    $('#especiais :input').prop('disabled',false);
                    $('#especiais2 :input').prop('disabled',false);
                  }
          ...
          <h5>
            ...
            <input type="radio" id="region"
             name="destpointType" value="region" disabled onclick="
                if (document.getElementById(2).checked==true) {
                    $('#especiais :input').prop('disabled',true);                    
                    $('#especiais2 :input').prop('disabled',true);
                }                  
             ">
            <label for="region">Region&emsp;&ensp;</label>
            <input type="radio" id="player"
             name="destpointType" value="player" disabled onclick="
                   $('#especiais :input').prop('disabled',false);
                   $('#especiais2 :input').prop('disabled',false);
             ">
            ...
            <h5>
              <div class="can-toggle can-toggle--size-small">
                <input id="2" type="checkbox" name="passe" value="passe" onclick="(function(){
                  ...
                  if ((document.getElementById(2).checked==true) &&  (document.getElementById('region').checked==true)) {
                    $('#especiais :input').prop('disabled',true);
                    $('#especiais2 :input').prop('disabled',true);}

                  if ((document.getElementById(2).checked==true) &&  (document.getElementById('player').checked==true)) {
                    $('#especiais :input').prop('disabled',false);
                    $('#especiais2 :input').prop('disabled',false);
                  }
  ...
  <center>  
            ...
            <div class="quote4">
              <h5 id="local">&nbsp;<br>&nbsp;Special Conditions <span style=" z-index: 10;" onclick="void(0);"  class="tooltip4"><img style="padding-bottom: 5px; " src='img/interrogacao1' onclick="//location.href='actiontype.php'" width='15' height='15'>
                <span class="info4">
                  ...
                  <span class="text4" style="color: #fff;">Select special situations where the new behavior <b>cannot</b> be performed. Please note that region passes are unsupported by this kind of configuration.</span>
                </span>
              </span>
              </h5>
            </div>
    ...
    <div class = "fancy2" id="especiais2">
    ...
    <div class="bottom2">
      ...
      <input class="btn waves-effect waves-light col l10 offset-l1 grey" type=submit value="Generate Behavior">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn waves-effect waves-light col l10 offset-l1 grey" type=button value="Backup Planner" onclick="backup();">
        <p id="teste"></p>
  ...
  <script type="text/javascript">
      function backup(){
          var x;
          var r=confirm("Are you sure you want to backup the current version of SPlanner toll?");
          if (r==true) {
            window.location.replace("http://localhost/Gerador/backupSplanner.php");
          }
          else {
