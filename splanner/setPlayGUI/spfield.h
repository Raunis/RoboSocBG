...
public:
    ...
    void changePlayers(QList <SpPlayer *> players, QList <SpPlayer *> playersOpponent);
    void removePlayerFromBench(SpPlayer *player);
    void removePlayerFromBenchOpponent(SpPlayer *p);
    void playerToBench(SpPlayer *player);
    void playerToBenchOpponent(SpPlayer *p);
...
private:
    ...
    QList<SpPlayer*> outPlayersOpponent;
    QList<SpPlayer *> inPlayersOpponent;
    ...
    void replaceBenchPlayersOpponent();
    void replaceParticipantPlayers();
    void  replaceParticipantPlayersOpponent();
