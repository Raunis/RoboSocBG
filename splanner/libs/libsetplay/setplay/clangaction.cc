...
const Action* ActPos::necessaryAction(const PlayerID& p,
	...
	if(!isAccomplished(p,world)){
		cerr << "clangaction::ActPos::necessaryAction: !accomplished\n";
		return this;
	}
	else
		return NULL;
...
/**************************************
 *  CRIA AS CHAMADAS DAS FUNÇÕES DA   *  
 *             CLASSE CLANG           *
 **************************************
 *    é necessário implementar ou     *
 *  substituir pelo códigos referente *
